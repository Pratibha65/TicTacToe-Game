...
def draw_status():
    ...
    screen.fill(BACKGROUND, (0, HEIGHT, WIDTH, 100))  # Correct: (0, HEIGHT, WIDTH, 100)
    ...
    #------------------------------
    text_rect = text.get_rect(center=(WIDTH / 2, HEIGHT + 50))  # Adjust y-coordinate for status bar
...
def check_win():
    ...
    # ... (rest of the check_win function remains the same)
...
def user_click():
    ...
    # ... (rest of the user_click function remains the same)
...
def reset_game():
    ...
    current_player = 'x'
    #----------------------
    message = current_winner.upper() + "'s Turn"
    # screen.fill(BACKGROUND, (0, HEIGHT, WIDTH, 100))
    is_draw = False
